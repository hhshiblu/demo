      ...
      <main className="app-content">
        ...
        <Card className="shadow-sm mb-6">
          <CardContent className="p-6 flex flex-col items-center">
            ...
            <h2 className="text-xl font-bold mt-4">{userData?.name?userData?.name:"israt shifa"}</h2>
            <p className="text-muted-foreground">{userData?.email?userData?.email:"israt55@gmail.com"}</p>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="name" defaultValue="Israt Shifa" className="pl-10" readOnly={!editMode} />
              </div>
            </div>
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="email" type="email" defaultValue="israt55@gmail.com"className="pl-10" readOnly={!editMode} />
              </div>
            </div>
